...
function addPolygon(params, children, widthRadius, startRadius, endRadian, color) {
    children.push({
        ...
        during: function (apiDuring) {
            apiDuring.setShape('points', makeShapePoints(params, apiDuring.getExtra('widthRadius'), apiDuring.getExtra('startRadius'), apiDuring.getExtra('endRadian')));
        }
    });
}
function makeShapePoints(params, widthRadius, startRadius, endRadian) {
    ...
    for (var iRadian = _startRadian, end = endRadian - _radianStep; iRadian > end; iRadian -= _radianStep) {
    ...
    for (var iRadian = endRadian; iRadian < _startRadian + _radianStep; iRadian += _radianStep) {
...
function addLabel(params, children, widthRadius, startRadius, endRadian, color) {
    ...
    children.push({
        ...
        during: function (apiDuring) {
            ...
            var point = makeLabelPosition(params, apiDuring.getExtra('widthRadius'), apiDuring.getExtra('startRadius'), endRadian);
